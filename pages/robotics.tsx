...
export default function RoboticsCourse() {
  ...
  const handleEnrollment = () => {
    setIsEnrolled(true);
    setTimeout(() => {
      router.push("/payment?course=robotics&price=6999");
    }, 1500);
  };

  return (
    <div className="bg-gradient-to-r from-gray-800 via-red-700 to-orange-600 min-h-screen">
      <Head>
        <title>Robotics & Automation Course - E-Learning</title>
      ...
      <section className="flex flex-col items-center justify-center text-center pt-32 pb-20 px-6">
        ...
        >
          Learn how to design, build, and program intelligent **robots** and **automated systems** to revolutionize industries.
        </motion.p>
        <motion.img
          src="/images/robo.jpg"
          alt="Robotics Course"
    ...
    transition={{ duration: 1.5 }}
      ...
      <section className="bg-white text-gray-900 py-20 px-6 rounded-t-3xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-10 container mx-auto">
          {[
            ...
            "Programming for Robotics (C++, Python)",
            ...
            <motion.div
              key={index}
              className="bg-red-600 text-white p-6 rounded-lg shadow-lg text-lg text-center"
              initial={{ opacity: 0, y: 50 }}
      ...
      <section className="bg-black text-white text-center py-20 px-6">
        ...
        <p className="mt-4 text-xl text-gray-300">
          Master **Robotics & Automation** and drive the future of technology!
        </p>
